...
def read_args():
	...
	parser.add_argument("--datapath", default="dataset/NELL/", type=str)
	...
	parser.add_argument("-epo", "--epoch", default=300000, type=int)
	...
	parser.add_argument("--neg_size", default=50, type=int)
