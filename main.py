...
CIAN ( https://github.com/cjlyl/FKGC-CIAN)
FAAN ( https://github.com/JiaweiSheng/FAAN)
"""
...
class Model_Run(object):
    ...
    def load_embed(self):
        ...
        if args.embed_model in ['DistMult', 'TransE', 'ComplEx', 'RESCAL']:
            ent_embed = np.loadtxt(args.datapath + '/entity2vec.' + args.embed_model)
            rel_embed = np.loadtxt(args.datapath + '/relation2vec.' + args.embed_model)  # contain inverse edge
    ...
    def train(self, args):
        ...
        for data in train_generate(args.datapath, args.batch_size, args.few, self.symbol2id, self.ent2id, self.e1rel_e2,self.neg_size):
...
if __name__ == '__main__':
    ...
    fh = logging.FileHandler('./logs_/logd-{}.txt'.format(args.prefix))
